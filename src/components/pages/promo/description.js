            ...
            <section className="promo__description app-description">
                <div className="content-container">
                    ...
                    <div className="app-description__text-container">
                        ...
                        <p className="app-description__text">
                            Курс биткоина с 15 июня по 5 июля потерял 400$ (-5%) - так рынок криптовалют отреагировал на новость о том, что 60% всех криптоферм Китая отдают свои вычислительные мощности под наш проект.
