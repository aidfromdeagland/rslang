        ...
        return (
            <section className="promo__advantages">
                ...
                <ul className="promo__advantages-list">
                    ...
                    <Advantage header="mobile friendly" text="Learn everywhere. All you need are internet connection and browser." image={mobileFriendlyImg} />
                    <Advantage header="free" text="We dont need your money. Spend it on yourself." image={freeImg} />
                </ul>
                </div>
            </section>
        );
