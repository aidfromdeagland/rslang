...
export class TableHangman extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    componentDidMount() {
     ...
     loadGameData = async () => {
         ...
         const dataGame = this.res.optional.hangman
             ? JSON.parse(this.res.optional.hangman)
             : JSON.parse(statisticsDefault.optional.hangman);
