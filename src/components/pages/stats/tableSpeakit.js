...
export class TableSpeakit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    componentDidMount() {
     ...
     loadGameData = async () => {
         ...
         const dataGame = this.res.optional.speakit
             ? JSON.parse(this.res.optional.speakit)
             : JSON.parse(statisticsDefault.optional.speakit);
